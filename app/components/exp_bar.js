...
module.exports = {
    ...
    mounted() {
        ...
        var growthRate = species 
            ...
            : PokeData.getSpecies(this.starterName).growth_rate;
        ...
        this.mapper.properties.player.team[0].expPoints.change(async (newProp, oldProp) => {
            ...
            if (this.expBarAnimation == true) {
                ...
                const growthRate = PokeData.getSpecies(currSpecies)?.growth_rate ?? PokeData.getSpecies(this.starterName).growth_rate // TODO - this may cause issues
