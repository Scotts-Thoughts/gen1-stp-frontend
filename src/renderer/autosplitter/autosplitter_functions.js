...
const fs = require("fs");
export function log_split(timer) {
    const time = Timer.formatted_time;
...
export function autosplitter_process() {
    if (this.autosplitter_toggle == true && this.runConfig.advanced.no_attempt == false) {
        ...
        const formattedTime = Timer.formatted_time;
        ...
        let full_data = [
            ...
            runIdentifier, this.meta.starter, trainerName,
            startTime, realTime, gameTime, level, this.metrics.resets,
            ...
            patch_movesLearnt,
            //new properties
            blackouts, this.metrics.attempts, failures, rivalTeam
        ]
        let deprecated_data = [
            runIdentifier, this.meta.starter, trainerName,
            startTime, realTime, gameTime, level, this.metrics.resets,
...
export function format_trainer_name(trainer_class, trainer_number) {
