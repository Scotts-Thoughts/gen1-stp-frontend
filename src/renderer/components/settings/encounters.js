...
export default {
    ...
    mounted: async function () {
        ...
        this.game_properties.overworld.map.change((newValue, oldValue) => {
            ...
            else if (newValue.value == "Viridian Forest" && this.game_name == "Yellow" && this.starterName == "Alakazam" && this.game_properties?.trainers?.viridianForest?.bugcatcher2?.value == false) {
                this.game_properties.patch.wEarlyEncounters.set("Off", false)
            }
        })
    }
